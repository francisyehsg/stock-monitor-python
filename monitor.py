...
def preview_stock(symbol, plot="Close"):
    """
    Utility function to show the last 2 weeks of stock performance
...
## python stockmonitor.py ['GOOG','FB','SPY'] --plot='Close' 
## python stockmonitor.py ['GOOG','FB','SPY'] --plot='Volume'